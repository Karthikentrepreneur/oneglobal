                ...
                <div key={index} className="flex flex-col items-center">
                  {link.external ? (
                    ...
                    <button
                      ...
                      className="w-full h-12 sm:h-14 md:h-16 flex flex-col gap-1 items-center justify-center text-xs sm:text-sm transition-all duration-300 rounded-lg shadow-sm hover:shadow-md hover:scale-105 bg-brand-navy text-slate-50"
                    >
                      {link.icon}
                      <span className="font-medium leading-none">{link.title}</span>
                    </button>
